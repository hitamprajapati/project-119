...
def drawBox(img,bbox):
    ...
    x,y,w,h=int(bbox[0]),int(bbox[1]),int(bbox[2]),int(bbox[3])
    cv2.rectangle(img,(x,y),((x+w),(y+h)),(200,201,202),3,1)
    cv2.putText(img,"tracking",(75,90),cv2.FONT_HERSHEY_COMPLEX,0.7,(65,47,249),2)    
...
while True:
   #Write the code inside loop here
    ...
    if success:
        ...
        cv2.putText(img,"lost!",(75,90),cv2.FONT_HERSHEY_COMPLEX,0.7,(65,47,249),2)    
